...
#if (IS_ANC_DIGITAL_MIC(TCFG_AUDIO_ANCL_FF_MIC) || \
     IS_ANC_DIGITAL_MIC(TCFG_AUDIO_ANCL_FB_MIC) || \
     IS_ANC_DIGITAL_MIC(TCFG_AUDIO_ANCR_FF_MIC) || \
     IS_ANC_DIGITAL_MIC(TCFG_AUDIO_ANCR_FB_MIC))
#define AUDIO_ANC_PDM_MIC_ENABLE	1
#else
#define AUDIO_ANC_PDM_MIC_ENABLE	0
#endif
