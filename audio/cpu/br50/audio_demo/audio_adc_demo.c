...
#define ADC_DEMO_CH_NUM        	6	/*支持的最大采样通道(max = 2)*/
...
void audio_adc_mic_demo_open(u8 mic_idx, u8 gain, int sr, u8 mic_2_dac)
{
...
#else
    struct mic_open_param mic_param[6] = {0};
    ...
    if (mic_idx & AUDIO_ADC_MIC_4) {
        mic_param[4].mic_mode      = AUDIO_MIC_CAP_MODE;
        mic_param[4].mic_ain_sel   = AUDIO_MIC4_CH0;
        mic_param[4].mic_bias_sel  = AUDIO_MIC_BIAS_CH4;
        mic_param[4].mic_bias_rsel = 2;
        mic_param[4].mic_dcc_en    = 1;
        mic_param[4].mic_dcc       = 1;
        audio_adc_mic_open(&mic_demo->mic_ch, AUDIO_ADC_MIC_4, &adc_hdl, &mic_param[4]);
        audio_adc_mic_set_gain(&mic_demo->mic_ch, AUDIO_ADC_MIC_4, gain);
        /* audio_adc_mic_gain_boost(AUDIO_ADC_MIC_4, 0); */
    }
    if (mic_idx & AUDIO_ADC_LPMIC) {
        mic_param[5].mic_mode      = AUDIO_MIC_CAP_MODE;
        mic_param[5].mic_ain_sel   = BIT(0);
        mic_param[5].mic_bias_sel  = AUDIO_MIC_BIAS_LP;
        mic_param[5].mic_bias_rsel = 2;
        mic_param[5].mic_dcc_en    = 1;
        mic_param[5].mic_dcc       = 1;
        audio_adc_mic_open(&mic_demo->mic_ch, AUDIO_ADC_LPMIC, &adc_hdl, &mic_param[5]);
        audio_adc_mic_set_gain(&mic_demo->mic_ch, AUDIO_ADC_LPMIC, gain);
    }
#endif
