...
#define AFx_PHASER_AT_RAM                   0   //phaser
#define AFx_FLANGER_AT_RAM                  0   //flanger
#define AFx_CHORUS_ADVANCE_AT_RAM           0   //chorus advance
#define AFx_PINGPONG_ECHO_AT_RAM            0   //pingpong echo
#define AFx_FREQUENCY_COMPRESSOR_AT_RAM     0   //frequency compressor
...
#define AUDIO_CVP_ELEVOC_AT_RAM				1	//ELEVOC
...
//**************************************
// 			IIS模块配置
// 		br50 alink 使用double buf模式，同步对中断响应的及时性要求较高，
// 		此处配置256点(6ms间隔)避免因bt驱动层的一些关中断行为，导致alink中断响应不及时,发生两次中断被合并的情况
//**************************************
//ADC中断点数
...
/*省电容mic模块使能*/
        ...
        (TCFG_ADC4_ENABLE && (TCFG_ADC4_MODE == 2)) || \
        (TCFG_LPADC_ENABLE && (TCFG_LPADC_MODE == 2)))
