...
#pragma bss_seg(".app_protocol_common.data.bss")
#pragma data_seg(".app_protocol_common.data")
#pragma const_seg(".app_protocol_common.text.const")
#pragma code_seg(".app_protocol_common.text")
#endif
