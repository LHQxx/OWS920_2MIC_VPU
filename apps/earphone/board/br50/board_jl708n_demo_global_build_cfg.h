#ifndef CONFIG_BOARD_JL708N_DEMO_POST_BUILD_CFG_H
#define CONFIG_BOARD_JL708N_DEMO_POST_BUILD_CFG_H
...
#ifdef CONFIG_BOARD_JL708N_DEMO
...
#define CONFIG_SUPPORTED_CHIP_VERSION			M,D

//DON'T MODIFY THIS CONFIG EXCEPT SDK PUBLISHER
#define CONFIG_CHIP_NAME                        JL708N              //除了SDK发布者,请不要修改
//it can be modified before first programming,but keep the same as the original version
#define CONFIG_PID                              JL708N              //烧写或强制升级之前可以修改,之后升级要保持一致
//it can be modified before first programming,but keep the same as the original version
...
#endif /* #ifdef CONFIG_BOARD_JL708N_DEMO */

#endif /* #ifndef CONFIG_BOARD_JL708N_DEMO_POST_BUILD_CFG_H */
