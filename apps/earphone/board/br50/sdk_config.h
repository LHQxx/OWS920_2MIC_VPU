...
#define TCFG_DCDC_TYPE PWR_DCDC18_DCDC12 // DCDC类型
#define TCFG_LOWPOWER_VDDIOM_LEVEL VDDIOM_VOL_28V // 强VDDIO
#define TCFG_LOWPOWER_VDDIOW_LEVEL VDDIOW_VOL_27V // 弱VDDIO
...
#define TCFG_SD0_PORT_CMD IO_PORTC_03 // SD_PORT_CMD
...
#define TCFG_HW_SPI1_PORT_CLK IO_PORTD_04 // SPI1 CLK脚
#define TCFG_HW_SPI1_PORT_DO IO_PORTD_05 // SPI1  DO脚
#define TCFG_HW_SPI1_PORT_DI IO_PORTD_03 // SPI1  DI脚
#define TCFG_HW_SPI1_PORT_D2 IO_PORTD_06 // SPI1 D2脚
#define TCFG_HW_SPI1_PORT_D3 IO_PORTD_07 // SPI1 D3脚
#define TCFG_HW_SPI1_MODE SPI_MODE_UNIDIR_4BIT // SPI1 模式
...
#define TCFG_HW_SPI2_PORT_D2 NO_CONFIG_PORT // SPI2  D2脚
#define TCFG_HW_SPI2_PORT_D3 NO_CONFIG_PORT // SPI2  D3脚
...
#define TCFG_FLASH_DEV_FLASH_READ_WIDTH SPI_MODE_UNIDIR_4BIT // 读Flash线宽模式
#define TCFG_FLASH_DEV_SPI_HW_NUM 1 // Flash选择哪组SPI
#define TCFG_FLASH_DEV_SPI_CS_PORT IO_PORTD_01 // Flash SPI CS脚
...
#define TCFG_LOCAL_TWS_SYNC_VOL 1 // 本地音乐音量同步
#define TCFG_BACKGROUND_WITHOUT_EDR_CONNECT 0 // 后台关闭经典蓝牙连接
#define LOCAL_TWS_CODEC_TYPE 131072 // 编解码格式
...
#define LOCAL_TWS_CODEC_SAMPLERATE 96000 // 采样率
#define LOCAL_TWS_CODEC_BIT_RATE 660000 // 码率
...
#define LE_AUDIO_JL_DONGLE_UNICAST_WITH_PHONE_CONN_SWITCH 0 // 使能
#define LE_AUDIO_JL_DONGLE_UNICAST_WITH_PHONE_CONN_CONFIG LE_AUDIO_JL_DONGLE_UNICAST_WITH_PHONE_CONN_PLAY_PREEMPTEDK // JL_UNICAST声音叠加
// ------------蓝牙配置.json------------
...
#define CONFIG_UPDATE_MUTIL_CPU_UART 0 // 支持多芯片交互升级
#define CONFIG_UPDATE_MACHINE_NUM 0 // 唯一设备号
#define CONFIG_UPDATE_MUTIL_CPU_UART_TX_PIN IO_PORTD_01 // TX_IO选择
#define CONFIG_UPDATE_MUTIL_CPU_UART_RX_PIN IO_PORTD_01 // RX_IO选择
...
#define TCFG_AUDIO_DAC_LP_PA_ISEL1 1 // PA_ISEL1
...
#define TCFG_ADC3_AIN_SEL 2 // 输入端口
#define TCFG_ADC3_BIAS_SEL 0 // 供电端口
#define TCFG_ADC3_BIAS_RSEL 3 // MIC BIAS上拉电阻挡位
#define TCFG_ADC3_POWER_IO IO_PORTA_00 // IO供电选择
#define TCFG_ADC3_DCC_EN 1 // DCC使能
#define TCFG_ADC3_DCC_LEVEL 1 // DCC 截止频率
#define TCFG_ADC4_ENABLE 0 // 使能
#define TCFG_ADC4_MODE 0 // 模式
#define TCFG_ADC4_AIN_SEL 1 // 输入端口
#define TCFG_ADC4_BIAS_SEL 16 // 供电端口
#define TCFG_ADC4_BIAS_RSEL 3 // MIC BIAS上拉电阻挡位
#define TCFG_ADC4_POWER_IO IO_PORTA_00 // IO供电选择
#define TCFG_ADC4_DCC_EN 1 // DCC使能
#define TCFG_ADC4_DCC_LEVEL 1 // DCC 截止频率
#define TCFG_LPADC_ENABLE 0 // 使能
#define TCFG_LPADC_MODE 0 // 模式
#define TCFG_LPADC_AIN_SEL 1 // 输入端口
#define TCFG_LPADC_BIAS_SEL 32 // 供电端口
#define TCFG_LPADC_BIAS_RSEL 3 // MIC BIAS上拉电阻挡位
#define TCFG_LPADC_POWER_IO IO_PORTA_00 // IO供电选择
#define TCFG_LPADC_DCC_EN 1 // DCC使能
#define TCFG_LPADC_DCC_LEVEL 1 // DCC 截止频率
...
#define TCFG_SPATIAL_EFFECT_ONLINE_ENABLE 1 // 空间音效在线调试
...
#define TCFG_DEC_LDAC_ENABLE 0 // LDAC
...
#define TCFG_ENC_LDAC_ENABLE 0 // LDAC
