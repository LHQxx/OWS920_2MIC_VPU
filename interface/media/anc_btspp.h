...
#define ANC_L_FFMIC_CMP_GAIN_SET	0xA1 		//ANCL FFmic 补偿增益(产测使用) --BR50
#define ANC_L_FBMIC_CMP_GAIN_SET	0xA2 		//ANCL FBmic 补偿增益(产测使用) --BR50
#define ANC_R_FFMIC_CMP_GAIN_SET	0xA3 		//ANCR FFmic 补偿增益(产测使用) --BR50
#define ANC_R_FBMIC_CMP_GAIN_SET	0xA4 		//ANCR FBmic 补偿增益(产测使用) --BR50
#define ANC_MIC_CMP_GAIN_EN_SET		0xA5 		//ANC mic 补偿增益使能控制(产测使用) --BR50
