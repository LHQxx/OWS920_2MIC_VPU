...
#define		MCLR_PORT		IO_PORTA_03

#define		LVD_PORT		IO_PORTD_00

//A B C D F P USB
#define PORT_TABLE(arg)		u32 gpio_confi##arg[7] = {IO_PORT_PA_MASK, IO_PORT_PB_MASK, IO_PORT_PC_MASK, IO_PORT_PD_MASK, IO_PORT_PF_MASK, IO_PORT_PP_MASK, IO_PORT_USB_MASK}
