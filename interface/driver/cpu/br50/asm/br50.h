...
#define JL_HMCFG_BASE                    (hs_base + map_adr(0x12, 0x00))
#define JL_HMCFG                         ((JL_HMCFG_TypeDef     *)JL_HMCFG_BASE)
...
#define JL_AMCFG_BASE                    (as_base + map_adr(0x30, 0x00))
#define JL_AMCFG                         ((JL_AMCFG_TypeDef     *)JL_AMCFG_BASE)
...
#define JL_WMCFG_BASE               (wl_base + map_adr(0x0f, 0x00))
#define JL_WMCFG                    ((JL_WMCFG_TypeDef     *)JL_WMCFG_BASE)
