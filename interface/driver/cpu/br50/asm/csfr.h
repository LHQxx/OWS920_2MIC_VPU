...
typedef struct {
    __RW __u32 CON[15]; // 0-3 used in br50
    __RO __u32 REV0;
    __RW __u32 CID[15]; // 0-3 used in br50
    __RO __u32 REV1;
    __RW __u32 BEG[15]; // 0-3 used in br50
    __RO __u32 REV2;
    __RW __u32 END[15]; // 0-3 used in br50
    __RW __u32 WREN;
} JL_MPU_TypeDef;
...
//............. 0x0b00 - 0x0cff............
typedef struct {
    __RO __u32 LPRAM0_0_RWCNT;
    __RO __u32 LPRAM0_0_LPCNT;
    __RO __u32 LPRAM0_0_ITCNT;
    __RO __u32 LPRAM0_1_RWCNT;
    __RO __u32 LPRAM0_1_LPCNT;
    __RO __u32 LPRAM0_1_ITCNT;
    __RO __u32 LPRAM0_2_RWCNT;
    __RO __u32 LPRAM0_2_LPCNT;
    __RO __u32 LPRAM0_2_ITCNT;
    __RO __u32 LPRAM0_3_RWCNT;
    __RO __u32 LPRAM0_3_LPCNT;
    __RO __u32 LPRAM0_3_ITCNT;
    __RO __u32 LPRAM0_4_RWCNT;
    __RO __u32 LPRAM0_4_LPCNT;
    __RO __u32 LPRAM0_4_ITCNT;
    __RO __u32 LPRAM0_5_RWCNT;
    __RO __u32 LPRAM0_5_LPCNT;
    __RO __u32 LPRAM0_5_ITCNT;
    __RO __u32 LPRAM0_6_RWCNT;
    __RO __u32 LPRAM0_6_LPCNT;
    __RO __u32 LPRAM0_6_ITCNT;
    __RO __u32 LPRAM0_7_RWCNT;
    __RO __u32 LPRAM0_7_LPCNT;
    __RO __u32 LPRAM0_7_ITCNT;
    __RO __u32 LPRAM1_0_RWCNT;
    __RO __u32 LPRAM1_0_LPCNT;
    __RO __u32 LPRAM1_0_ITCNT;
    __RO __u32 LPRAM1_1_RWCNT;
    __RO __u32 LPRAM1_1_LPCNT;
    __RO __u32 LPRAM1_1_ITCNT;
    __RO __u32 LPRAM1_2_RWCNT;
    __RO __u32 LPRAM1_2_LPCNT;
    __RO __u32 LPRAM1_2_ITCNT;
    __RO __u32 LPRAM1_3_RWCNT;
    __RO __u32 LPRAM1_3_LPCNT;
    __RO __u32 LPRAM1_3_ITCNT;
    __RO __u32 LPRAM1_4_RWCNT;
    __RO __u32 LPRAM1_4_LPCNT;
    __RO __u32 LPRAM1_4_ITCNT;
    __RO __u32 LPRAM1_5_RWCNT;
    __RO __u32 LPRAM1_5_LPCNT;
    __RO __u32 LPRAM1_5_ITCNT;
    __RO __u32 LPRAM1_6_RWCNT;
    __RO __u32 LPRAM1_6_LPCNT;
    __RO __u32 LPRAM1_6_ITCNT;
    __RO __u32 LPRAM1_7_RWCNT;
    __RO __u32 LPRAM1_7_LPCNT;
    __RO __u32 LPRAM1_7_ITCNT;
    __RO __u32 LPRAM2_RWCNT;
    __RO __u32 LPRAM2_LPCNT;
    __RO __u32 LPRAM2_ITCNT;
    __RO __u32 LPRAM3_RWCNT;
    __RO __u32 LPRAM3_LPCNT;
    __RO __u32 LPRAM3_ITCNT;
    __RO __u32 LPRAM4_RWCNT;
    __RO __u32 LPRAM4_LPCNT;
    __RO __u32 LPRAM4_ITCNT;
    __RO __u32 LPRAM5_RWCNT;
    __RO __u32 LPRAM5_LPCNT;
    __RO __u32 LPRAM5_ITCNT;
    __RW __u32 LP_MSG;
    __RW __u32 LGC_GATE_EN;
    __RW __u32 MCFG_CON0;
    __RW __u32 MCFG_CON1;
    __RW __u32 CEPRD_8K;
    __RW __u32 LSPRD_8K;
    __RW __u32 DSPRD_8K;
    __RW __u32 RMPRD_8K;
    __RW __u32 CEPRD_64K;
    __RW __u32 LSPRD_64K;
    __RW __u32 DSPRD_64K;
    __RW __u32 RMPRD_64K;
    __RO __u32 LS_PND;
    __RO __u32 DS_PND;
    __RO __u32 RM_PND;
    __RO __u32 CE_PND;
...
#define JL_LPRAM_BASE                 (csfr_base + map_adr(0x0b, 0x00))
#define JL_LPRAM                      ((JL_LPRAM_TypeDef  *)JL_LPRAM_BASE)
...
typedef struct {
    ...
    /* 7a */  __RO __u32 ETM_PC4;
    /* 7b */  __RO __u32 ETM_PC5;
    /*    */  __RO __u32 REV7b[0x80 - 0x7b - 1];
